...
@Component({
  selector: 'app-dashboard-caste',
  templateUrl: './dashboard-caste.component.html',
  styleUrls: ['./dashboard-caste.component.css']
})
export class DashboardCasteComponent implements OnInit {
    ...
    this.dashboardserivce
      ...
      .subscribe((data: any) => {
        for (
          ...
          this.labelList.push(this.chartdata[this.index].caste);
